...
def init_db():
    ...
    if count == 0:
        products = [
            ...
            ('Cheese', 'Dairy', 280.00, 210.00, 15, 'packets'),
            ('Potato Chips', 'Snacks', 30.00, 20.00, 25, 'packets'),
            ('Thumps UP 2L', 'Beverages', 90.00, 65.00, 5, 'bottles'),
            ...
            ('Tea Powder', 'Beverages', 150.00, 100.00, 18, 'boxes'),
            ('Sunflower Oil', 'Cooking', 320.00, 240.00, 10, 'bottles'),
            ('Mixture 400g', 'Snacks', 80.00, 55.00, 3, 'packs'),
